...
import { LogOut, UserCheck, Grid3X3, Shield, Bookmark, User, CheckCircle, Inbox, Briefcase, MessageSquare, Sparkles, Calendar, Target, Star, BarChart2, BookOpen, Clock, FileText, Building2, Users, LayoutGrid } from 'lucide-react';
...
function VeluLogo({ size = 26, variant = "coral" }) {
  if (variant === "dual") {
    return /* @__PURE__ */ jsxs("svg", { width: size, height: size, viewBox: "0 0 56 56", fill: "none", children: [
      /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsx("clipPath", { id: "velu-clip", children: /* @__PURE__ */ jsx("rect", { width: "56", height: "56", rx: "14" }) }) }),
      /* @__PURE__ */ jsxs("g", { clipPath: "url(#velu-clip)", children: [
        /* @__PURE__ */ jsx("polygon", { points: "0,0 56,0 28,56 0,56", fill: "#F97316" }),
        /* @__PURE__ */ jsx("polygon", { points: "56,0 56,56 28,56", fill: "#0D7A6E" })
      ] }),
      /* @__PURE__ */ jsx("line", { x1: "10", y1: "11", x2: "28", y2: "45", stroke: "white", strokeWidth: "5", strokeLinecap: "round", opacity: "0.45" }),
      /* @__PURE__ */ jsx("line", { x1: "46", y1: "11", x2: "28", y2: "45", stroke: "white", strokeWidth: "8.5", strokeLinecap: "round" })
    ] });
  }
  const bg = variant === "teal" ? "#0D7A6E" : "#F97316";
  return /* @__PURE__ */ jsxs("svg", { width: size, height: size, viewBox: "0 0 56 56", fill: "none", children: [
    /* @__PURE__ */ jsx("rect", { width: "56", height: "56", rx: "14", fill: bg }),
    /* @__PURE__ */ jsx("line", { x1: "10", y1: "11", x2: "28", y2: "45", stroke: "white", strokeWidth: "5", strokeLinecap: "round", opacity: "0.45" }),
    /* @__PURE__ */ jsx("line", { x1: "46", y1: "11", x2: "28", y2: "45", stroke: "white", strokeWidth: "8.5", strokeLinecap: "round" })
  ] });
}
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: src ? (
        ...
        /* @__PURE__ */ jsx("img", { src, alt: name, className: "w-full h-full object-cover" })
      ) : /* @__PURE__ */ jsx("span", { className: text, children: getInitials(name) })
    }
  );
}
var DEFAULT_MODULES = [
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", height: "100%", flexShrink: 0, minWidth: 0 }, children: [
          /* @__PURE__ */ jsxs(Link, { href: logoHref, style: { display: "flex", alignItems: "center", gap: 8, flexShrink: 0, textDecoration: "none" }, children: [
            /* @__PURE__ */ jsx(VeluLogo, { size: 26, variant: logoVariant }),
            /* @__PURE__ */ jsx("span", { style: { fontFamily: "'DM Serif Display', serif", fontSize: 18, color: "white", letterSpacing: "-0.02em" }, children: "Velu" })
          ] }),
          /* @__PURE__ */ jsx("div", { style: { width: 1, height: 20, background: "rgba(255,255,255,0.1)", margin: "0 16px", flexShrink: 0 } }),
          /* @__PURE__ */ jsx("div", { style: { display: "flex", alignItems: "stretch", height: "100%" }, children: modules.map((mod) => {
            const isActive = pathname.startsWith(mod.href);
            const showDivider = DIVIDER_AFTER.includes(mod.href);
            return /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "stretch" }, children: [
              /* @__PURE__ */ jsxs(
                Link,
                {
                  href: mod.href,
                  ...
                  children: [
                    /* @__PURE__ */ jsx("span", { style: { width: 6, height: 6, borderRadius: "50%", background: mod.color, flexShrink: 0 } }),
                    mod.label
                  ]
                }
              ),
              showDivider && /* @__PURE__ */ jsx("div", { style: { width: 1, height: 20, background: "rgba(255,255,255,0.1)", margin: "auto 4px", flexShrink: 0 } })
            ] }, mod.href);
          }) })
        ] }),
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12, flexShrink: 0, marginLeft: 16 }, children: [
          /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "hidden sm:block", children: [
              /* @__PURE__ */ jsx("div", { style: { fontSize: 13, fontWeight: 600, color: "white", lineHeight: 1.2 }, children: userName }),
              userRole && /* @__PURE__ */ jsx("div", { style: { fontSize: 11, color: "rgba(255,255,255,0.4)", lineHeight: 1.2 }, children: userRole })
            ] })
          ] }),
          onLogout && /* @__PURE__ */ jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsx(LogOut, { size: 15 })
            }
          )
        ] })
      ]
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsx("h1", { className: "font-display text-2xl tracking-tight", style: { color: "#1C1C1E" }, children: title }),
          subtitle && /* @__PURE__ */ jsx("p", { className: "text-[13px] mt-0.5", style: { color: "#6B6B6E" }, children: subtitle })
        ] }),
...
function Button(_a) {
  ...
  return /* @__PURE__ */ jsxs(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        loading && /* @__PURE__ */ jsxs("svg", { className: "animate-spin w-3.5 h-3.5", fill: "none", viewBox: "0 0 24 24", children: [
...
function Badge(_a) {
  ...
  return /* @__PURE__ */ jsxs("span", __spreadProps(__spreadValues({ className: cn(badgeVariants({ variant, size }), className) }, props), { children: [
    dot && /* @__PURE__ */ jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-current" }),
    children
  ] }));
}
var paddingMap = {
...
function StatCard({ label, value, delta, icon, iconColor = "bg-[#FFF5ED] text-[#F97316]", className }) {
  return /* @__PURE__ */ jsxs(Card, { padding: "md", className: cn("flex items-center gap-4", className), children: [
    icon && /* @__PURE__ */ jsx("div", { className: cn("w-11 h-11 rounded-[10px] flex items-center justify-center flex-shrink-0", iconColor), children: icon }),
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("div", { className: "font-display text-[28px] text-[#1C1C1E] leading-none tracking-tight", children: value }),
      delta && /* @__PURE__ */ jsx("div", { className: "text-[12px] text-[#0D7A6E] mt-1", children: delta }),
      /* @__PURE__ */ jsx("div", { className: "text-[12px] text-[#6B6B6E] mt-0.5", children: label })
    ] })
  ] });
}
function ProgressBar({ value, max = 100, color = "#0D7A6E", size = "sm", showLabel, className }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("flex items-center gap-3", className), children: [
    /* @__PURE__ */ jsx("div", { className: cn("flex-1 bg-[#EDEAE3] rounded-full overflow-hidden", size === "sm" ? "h-1.5" : "h-2.5"), children: /* @__PURE__ */ jsx(
      "div",
      {
    ...
    showLabel && /* @__PURE__ */ jsxs("span", { className: "text-[12px] font-semibold text-[#6B6B6E] w-8 text-right flex-shrink-0", children: [
      Math.round(pct),
      "%"
    ] })
  ] });
...
function EmptyState({ icon = "\u{1F4ED}", title, description, action, className }) {
  return /* @__PURE__ */ jsxs("div", { className: cn("flex flex-col items-center justify-center py-16 px-8 text-center", className), children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "font-display text-xl text-[#1C1C1E] tracking-tight", children: title }),
    description && /* @__PURE__ */ jsx("p", { className: "text-[14px] text-[#6B6B6E] mt-2 max-w-sm", children: description }),
    action && /* @__PURE__ */ jsx("div", { className: "mt-5", children: action })
  ] });
}
function DataTable({ columns, data, empty, className }) {
  return /* @__PURE__ */ jsx("div", { className: cn("bg-[#FDFCFA] rounded-[20px] border border-[#EDEAE3] overflow-hidden shadow-[0_2px_10px_rgba(28,28,30,0.07)]", className), children: /* @__PURE__ */ jsxs("table", { className: "w-full border-collapse text-[14px]", children: [
    ...
    /* @__PURE__ */ jsxs("tbody", { children: [
      data.map((row) => /* @__PURE__ */ jsx("tr", { className: "hover:bg-[#EFEDE8] transition-colors", children: columns.map((col) => {
        var _a;
        return /* @__PURE__ */ jsx("td", { className: "px-4 py-3 border-b border-[#EDEAE3]", children: col.render ? col.render(row) : String((_a = row[col.key]) != null ? _a : "\u2014") }, col.key);
      }) }, row.id)),
      data.length === 0 && /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: columns.length, className: "px-4 py-12 text-center text-[#6B6B6E] text-[14px]", children: empty != null ? empty : "No data yet." }) })
    ] })
  ] }) });
}
function Input(_a) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1.5", children: [
    label && /* @__PURE__ */ jsx("label", { htmlFor: inputId, className: "text-[13px] font-semibold text-[#3A3A3C]", children: label }),
    /* @__PURE__ */ jsx(
      "input",
      __spreadValues({
        id: inputId,
    ...
    hint && !error && /* @__PURE__ */ jsx("p", { className: "text-[12px] text-[#6B6B6E]", children: hint }),
    error && /* @__PURE__ */ jsx("p", { className: "text-[12px] text-red-500", children: error })
  ] });
}

export { Avatar, Badge, Button, Card, DataTable, EmptyState, Input, PageHeader, ProgressBar, StatCard, SubNav, TopNav, VeluLogo, cn, formatDate, formatDateShort, getInitials };
